...
def convert_to_markdown(index, url):
    """
    holt die Seite zum link und wandelt sie in markdown mithilfe von pandoc um
    """
    # url abrufen
    ...
    output = pypandoc.convert_text(
        ...
        "markdown",
        format="html",
        outputfile="./md_files/md_file" + "{:03d}".format(index) + ".md",
    )
...
if __name__ == "__main__":
    ...
    # write_to_file(all_links_liste)

    for index, link in enumerate(all_links_liste):
        convert_to_markdown(index, link)
